...
describe('web3.ele.sendIBANTransaction', function () {
    it('should send transaction', function () {

        var iban = 'XE79ELEXREGGAVOFYORK';
        ...
        provider.injectValidation(function (payload) {
            if (step === 0) {
                ...
                assert.deepEqual(payload.params, [{
                   ...
                   to: web3.ele.icapNamereg().address
                }, "latest"]);
        ...
        web3.ele.sendIBANTransaction(address, iban, 10000);
